...
function createController(config: ExtensionConfig, sitePolicy: SitePolicy): PageController {
  const options: ConstructorParameters<typeof PageController>[0] = {
    ...
    ...(sitePolicy.containerMinTextCount !== undefined ? { containerMinTextCount: sitePolicy.containerMinTextCount } : {}),
    ...
    selectorFallbackPolicy: sitePolicy.selectorFallbackPolicy,
